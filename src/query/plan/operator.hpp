// -*- buffer-read-only: t; -*-
// vim: readonly
// DO NOT EDIT! Generated using LCP from '/home/hjm/memgraph/src/query/plan/operator.lcp'
...
/// pulled.
        ...
        public:
            ...
            private:
                ...
                std::list<std::pair<query::TypedValue,query::TypedValue>> history_add_;//history_edges history_vertexs

                bool InitHistoryEdges(Frame &, ExecutionContext &);
                void InitHistoryEdgesByCurrentVertex(Frame &frame,ExecutionContext &context,TypedValue&);
                void InitHistoryEdgesByHistoryVertex(Frame &frame,ExecutionContext &context,TypedValue &vertex_value);
                // std::optional<std::list<storage::HistoryEdge*>> in_history_edges_;
                // std::optional<std::list<storage::HistoryEdge*>> out_history_edges_;
                std::optional<std::list<std::pair<storage::HistoryEdge*,storage::HistoryVertex*>>> in_history_edges_;
                std::optional<std::list<std::pair<storage::HistoryEdge*,storage::HistoryVertex*>>> out_history_edges_;
                //hjm end
            };
