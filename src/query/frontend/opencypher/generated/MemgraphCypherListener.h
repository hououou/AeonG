...
public:
  ...
  virtual void enterSnapshotQuery(MemgraphCypher::SnapshotQueryContext *ctx) = 0;
  virtual void exitSnapshotQuery(MemgraphCypher::SnapshotQueryContext *ctx) = 0;
  ...
  virtual void enterTt(MemgraphCypher::TtContext *ctx) = 0;
  virtual void exitTt(MemgraphCypher::TtContext *ctx) = 0;

  virtual void enterVt(MemgraphCypher::VtContext *ctx) = 0;
  virtual void exitVt(MemgraphCypher::VtContext *ctx) = 0;
