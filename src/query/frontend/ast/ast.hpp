...
struct hash<query::EdgeTypeIx> {
  size_t operator()(const query::EdgeTypeIx &edge_type) const { return edge_type.ix; }
};
...
class Expression : public query::Tree,
...
class Where : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Expression *expression_{nullptr};
...
class Tt : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  bool Accept(HierarchicalTreeVisitor &visitor) override { return visitor.PostVisit(*this); }

  query::Expression *tt_left_{nullptr};
  query::Expression *tt_right_{nullptr};

  Tt *Clone(AstStorage *storage) const override {
    Tt *object = storage->Create<Tt>();
    object->tt_left_ = tt_left_ ? tt_left_->Clone(storage) : nullptr;
    object->tt_right_ = tt_right_ ? tt_right_->Clone(storage) : nullptr;
    return object;
  }

 protected:
  Tt(query::Expression *tt_left, query::Expression *tt_right) : tt_left_(tt_left), tt_right_(tt_right) {}

 private:
  friend class AstStorage;
};

class BinaryOperator : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Expression *expression1_{nullptr};
  query::Expression *expression2_{nullptr};
...
class UnaryOperator : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class OrOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class XorOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class AndOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class AdditionOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class SubtractionOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class MultiplicationOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class DivisionOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class ModOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class NotEqualOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class EqualOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class LessOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class GreaterOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class LessEqualOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class GreaterEqualOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class InListOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class SubscriptOperator : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class NotOperator : public query::UnaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class UnaryPlusOperator : public query::UnaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class UnaryMinusOperator : public query::UnaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class IsNullOperator : public query::UnaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class Aggregation : public query::BinaryOperator {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  static std::string OpToString(Op op) {
    const char *op_strings[] = {kCount, kMin, kMax, kSum, kAvg, kCollect, kCollect};
...
class ListSlicingOperator : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Expression *list_{nullptr};
  query::Expression *lower_bound_{nullptr};
  query::Expression *upper_bound_{nullptr};
...
class IfOperator : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  /// PrimitiveLiteral.
  query::Expression *condition_;
  query::Expression *then_expression_;
  query::Expression *else_expression_;
...
class BaseLiteral : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class PrimitiveLiteral : public query::BaseLiteral {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class ListLiteral : public query::BaseLiteral {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::Expression *> elements_;
...
class MapLiteral : public query::BaseLiteral {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::unordered_map<query::PropertyIx, query::Expression *> elements_;
...
class Identifier : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class PropertyLookup : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class LabelsTest : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Expression *expression_{nullptr};
  std::vector<query::LabelIx> labels_;
...
class Function : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::Expression *> arguments_;
...
class Reduce : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Identifier *accumulator_{nullptr};
  /// Expression which produces the initial accumulator value.
  query::Expression *initializer_{nullptr};
  /// Identifier for the list element.
  query::Identifier *identifier_{nullptr};
...
class Coalesce : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::Expression *> expressions_;
...
class Extract : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class All : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Identifier *identifier_{nullptr};
  query::Expression *list_expression_{nullptr};
  query::Where *where_{nullptr};
...
class Single : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class Any : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class None : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class ParameterLookup : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class RegexMatch : public query::Expression {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Expression *string_expr_;
  query::Expression *regex_;
...
class NamedExpression : public query::Tree,
                        public utils::Visitable<HierarchicalTreeVisitor>,
                        public utils::Visitable<ExpressionVisitor<TypedValue>>,
                        public utils::Visitable<ExpressionVisitor<void>> {
 public:
...
class PatternAtom : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class NodeAtom : public query::PatternAtom {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::LabelIx> labels_;
  std::variant<std::unordered_map<query::PropertyIx, query::Expression *>, query::ParameterLookup *> properties_;
...
class EdgeAtom : public query::PatternAtom {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }

  enum class Type { SINGLE, DEPTH_FIRST, BREADTH_FIRST, WEIGHTED_SHORTEST_PATH };
  ...
  struct Lambda {
    ...
    query::Identifier *inner_edge{nullptr};
    /// Argument identifier for the destination node of the edge.
    query::Identifier *inner_node{nullptr};
  ...
  query::EdgeAtom::Type type_{Type::SINGLE};
  query::EdgeAtom::Direction direction_{Direction::BOTH};
  std::vector<query::EdgeTypeIx> edge_types_;
  std::variant<std::unordered_map<query::PropertyIx, query::Expression *>, query::ParameterLookup *> properties_;
...
class Pattern : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Identifier *identifier_{nullptr};
  std::vector<query::PatternAtom *> atoms_;
...
class Clause : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class SingleQuery : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::Clause *> clauses_;
...
class CypherUnion : public query::Tree, public utils::Visitable<HierarchicalTreeVisitor> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::SingleQuery *single_query_{nullptr};
...
class Query : public query::Tree, public utils::Visitable<QueryVisitor<void>> {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class CypherQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::CypherUnion *> cypher_unions_;
  query::Expression *memory_limit_{nullptr};
...
class ExplainQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::CypherQuery *cypher_query_{nullptr};
...
class ProfileQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class IndexQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::IndexQuery::Action action_;
  query::LabelIx label_;
  std::vector<query::PropertyIx> properties_;
...
class Create : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::Pattern *> patterns_;
...
class CallProcedure : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  std::vector<query::Identifier *> result_identifiers_;
  query::Expression *memory_limit_{nullptr};
  size_t memory_scale_{1024U};
  bool is_write_;
...
class Match : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  Match *Clone(AstStorage *storage) const override {
    ...
    object->tt_ = tt_ ? tt_->Clone(storage) : nullptr;
    return object;
  }
...
struct ReturnBody {
  ...
  std::vector<query::NamedExpression *> named_expressions;
  ...
  query::Expression *skip{nullptr};
  /// Optional expression on how many results to produce.
  query::Expression *limit{nullptr};
...
class Return : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class With : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class Delete : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class SetProperty : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::PropertyLookup *property_lookup_{nullptr};
  query::Expression *expression_{nullptr};
...
class SetProperties : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class SetLabels : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class RemoveProperty : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class RemoveLabels : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class Merge : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Pattern *pattern_{nullptr};
  std::vector<query::Clause *> on_match_;
  std::vector<query::Clause *> on_create_;
...
class Unwind : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::NamedExpression *named_expression_{nullptr};
...
class AuthQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
const std::vector<AuthQuery::Privilege> kPrivilegesAll = {
    ...
    AuthQuery::Privilege::SNAPSHOT};

class InfoQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::InfoQuery::InfoType info_type_;
...
struct Constraint {
  ...
  query::LabelIx label;
  std::vector<query::PropertyIx> properties;
...
class ConstraintQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::ConstraintQuery::ActionType action_type_;
  query::Constraint constraint_;
...
class DumpQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class ReplicationQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::ReplicationQuery::Action action_;
  query::ReplicationQuery::ReplicationRole role_;
  std::string replica_name_;
  query::Expression *socket_address_{nullptr};
  query::Expression *port_{nullptr};
  query::ReplicationQuery::SyncMode sync_mode_;
  query::Expression *timeout_{nullptr};
...
class LockPathQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::LockPathQuery::Action action_;
...
class LoadCsv : public query::Clause {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::Expression *file_;
  bool with_header_;
  bool ignore_bad_;
  query::Expression *delimiter_{nullptr};
  query::Expression *quote_{nullptr};
  query::Identifier *row_var_{nullptr};
...
class FreeMemoryQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class TriggerQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::TriggerQuery::Action action_;
  query::TriggerQuery::EventType event_type_;
...
class IsolationLevelQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::IsolationLevelQuery::IsolationLevel isolation_level_;
  query::IsolationLevelQuery::IsolationLevelScope isolation_level_scope_;
...
class CreateSnapshotQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class StreamQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::StreamQuery::Action action_;
  query::StreamQuery::Type type_;
  std::string stream_name_;
  query::Expression *batch_limit_{nullptr};
  query::Expression *timeout_{nullptr};
  std::string transform_name_;
  query::Expression *batch_interval_{nullptr};
  query::Expression *batch_size_{nullptr};
  std::variant<query::Expression *, std::vector<std::string>> topic_names_{nullptr};
  std::string consumer_group_;
  query::Expression *bootstrap_servers_{nullptr};
  query::Expression *service_url_{nullptr};
  std::unordered_map<query::Expression *, query::Expression *> configs_;
  std::unordered_map<query::Expression *, query::Expression *> credentials_;
...
class SettingQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  query::SettingQuery::Action action_;
  query::Expression *setting_name_{nullptr};
  query::Expression *setting_value_{nullptr};
...
class VersionQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
...
class SnapshotQuery : public query::Query {
 public:
  static const utils::TypeInfo kType;
  const utils::TypeInfo &GetTypeInfo() const override { return kType; }
  ...
  SnapshotQuery *Clone(AstStorage *storage) const override {
    SnapshotQuery *object = storage->Create<SnapshotQuery>();
    return object;
  }
};
